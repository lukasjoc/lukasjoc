<head>
	...
	<link rel="shortcut icon" type="image/x-icon" href="https://avatars1.githubusercontent.com/u/45790416">
	<title>Lukas Jocham | Software Programmer from Munich, Germany</title>
</head>
...
- Sound (nD, processing etc.)
- Linux
- Doing stuff with data
- underwater SeaLines
- Satelites
- Understanding intend
- Robotics
- Neuro Science
- Modelling, Creating hypothetical computer models of current and long gone nature and nurture (CAs etc)

### What I use:
- [Go](https://golang.org/)
- [Rust](https://www.rust-lang.org/)
- [Python or IPython](https://python.org/)
...
- [Demian](https://www.youtube.com/watch?v=bhgFXQIOMTA)
- [Stunden im Garten](https://www.youtube.com/watch?v=rwwQKgq8Mzc)
- [Platon und Nietzsche Un-Zeitgenossen im Gespräch](https://www.youtube.com/watch?v=7NXdY-vq4CQ)
- [Traue keinem Scan, den du nicht selbst gefälscht hast](https://www.youtube.com/watch?v=7FeqF1-Z1g0)
- [SpiegelMining](https://www.youtube.com/watch?v=-YpwsdRKt8Q)
- [BahnMining](https://www.youtube.com/watch?v=0rb9CfOvojk)
- [ROHDATEN sind soo geil...](https://www.youtube.com/watch?v=p4wENZAK7n8)
