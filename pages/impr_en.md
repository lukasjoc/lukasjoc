...
Contact1(preferred): [Twitter](https://twitter.com/lukasjoc) \
Contact2: [E-Mail](mailto:jochamlu@gmail.com) \
Responsible Person: Lukas Jocham

## Liability for contents
As a service provider, we are responsible for our own content on these pages in accordance with § 7 Para.1 TMG and
general laws. **However, according to §§ 8 to 10 TMG, we as service providers are not
